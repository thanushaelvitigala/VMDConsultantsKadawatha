...
export default function StudyInUKPage() {
  ...
  const faqs = [
    {
      question: "Is the UK process hard? How long does it take?",
      answer:
    ...
    {
      question: "Many not recommend UK?",
      answer:
        "Yes, many who do not have the capacity does not recommend. But we at VMD ensure that a solicitor firm is attached to us and you will have legal representation if there’s any issues regarding your paperwork or process.",
    },
    {
  ...
  const bannerUrl =
    "https://images.unsplash.com/photo-1567767295564-e6a0119a2239?auto=format&fit=crop&w=1332&q=80"; // London/University background
  const whyUkImage =
    "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=900&q=80"; // Students studying together
  const faqImage =
    "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=800&q=80"; // Student with books
  ...
  return (
    <div className="mt-20">
      ...
      <section className="container mx-auto px-6 md:px-16 py-16 grid md:grid-cols-2 gap-10 items-center">
        <div>
          <h2 className="text-3xl font-bold mb-4 text-[#660000]">Why UK?</h2>
          <ul className="list-disc list-inside space-y-2 text-gray-700 leading-relaxed">
            ...
            <li>
              Research-intensive programs and globally respected qualifications.
            </li>
            <li>
              Creative teaching methodologies that build confidence and skills.
            </li>
          </ul>
        </div>
      ...
      <section className="bg-gray-50 py-16 px-6 md:px-16">
        <div className="container mx-auto">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 leading-relaxed">
            ...
            <li>Career pathway and professional advice.</li>
            <li>Legal representation through our partnered solicitor firm.</li>
